...
var CloudFormationClient = /** @class */ (function () {
    ...
    CloudFormationClient.prototype.createStack = function (template, name, defParams, addAppSyncApiName) {
        if (defParams === void 0) { defParams = {}; }
        if (addAppSyncApiName === void 0) { addAppSyncApiName = true; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    CloudFormationClient.prototype.waitForStack = function (name, success, failure, poll, maxPolls, pollInterval) {
        ...
        if (maxPolls === void 0) { maxPolls = 1000; }
        if (pollInterval === void 0) { pollInterval = 20; }
        return __awaiter(this, void 0, void 0, function () {
            var stack;
            return __generator(this, function (_a) {
                switch (_a.label) {
