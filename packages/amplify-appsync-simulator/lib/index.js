...
exports.addDataLoader = data_loader_2.addDataLoader;
exports.removeDataLoader = data_loader_2.removeDataLoader;
...
__export(require("./type-definition"));
var DEFAULT_SCHEMA = "\ntype Query {\n  noop: String\n}\n";
    ...
    AmplifyAppSyncSimulator.prototype.init = function (config) {
        ...
        try {
            ...
            this.mappingTemplates = config.mappingTemplates.reduce(function (map, template) {
                map.set(template.path, new velocity_1.VelocityTemplate(template, _this));
                return map;
            }, new Map());
            ...
            this.functions = (config.functions || []).reduce(function (map, fn) {
                ...
                map.set(fn.name, new function_1.AmplifySimulatorFunction({
