...
function applyCompositeKeyConditionExpression(keyNames, queryExprReference, sortKeyArgumentName, sortKeyAttributeName) {
    ...
    return graphql_mapping_template_1.block("Applying Key Condition", [
        ...
        graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ") && !$util.isNull($ctx.args." + sortKeyArgumentName + ".beginsWith)"), graphql_mapping_template_1.compoundExpression(__spreadArrays(keyNames.map(function (keyName, idx) { return graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ".beginsWith." + keyName + ")"), idx === 0 ?
        ...
        graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ") && !$util.isNull($ctx.args." + sortKeyArgumentName + ".between)"), graphql_mapping_template_1.compoundExpression(__spreadArrays([
        ...
        ], keyNames.map(function (keyName, idx) { return graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ".between[0]." + keyName + ")"), idx === 0 ?
            ...
            graphql_mapping_template_1.set(graphql_mapping_template_1.ref(accumulatorVar1), graphql_mapping_template_1.str("$" + accumulatorVar1 + sep + "$ctx.args." + sortKeyArgumentName + ".between[0]." + keyName)), true); }), keyNames.map(function (keyName, idx) { return graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ".between[1]." + keyName + ")"), idx === 0 ?
        ...
        graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ") && !$util.isNull($ctx.args." + sortKeyArgumentName + ".eq)"), graphql_mapping_template_1.compoundExpression(__spreadArrays(keyNames.map(function (keyName, idx) { return graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ".eq." + keyName + ")"), idx === 0 ?
        ...
        graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ") && !$util.isNull($ctx.args." + sortKeyArgumentName + ".lt)"), graphql_mapping_template_1.compoundExpression(__spreadArrays(keyNames.map(function (keyName, idx) { return graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ".lt." + keyName + ")"), idx === 0 ?
        ...
        graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ") && !$util.isNull($ctx.args." + sortKeyArgumentName + ".le)"), graphql_mapping_template_1.compoundExpression(__spreadArrays(keyNames.map(function (keyName, idx) { return graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ".le." + keyName + ")"), idx === 0 ?
        ...
        graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ") && !$util.isNull($ctx.args." + sortKeyArgumentName + ".gt)"), graphql_mapping_template_1.compoundExpression(__spreadArrays(keyNames.map(function (keyName, idx) { return graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ".gt." + keyName + ")"), idx === 0 ?
        ...
        graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ") && !$util.isNull($ctx.args." + sortKeyArgumentName + ".ge)"), graphql_mapping_template_1.compoundExpression(__spreadArrays(keyNames.map(function (keyName, idx) { return graphql_mapping_template_1.iff(graphql_mapping_template_1.raw("!$util.isNull($ctx.args." + sortKeyArgumentName + ".ge." + keyName + ")"), idx === 0 ?
...
function validateCompositeKeyArguments(keys) {
    ...
    if (sortKeys.length > 1) {
        ...
        var validateBetween = function () { return graphql_mapping_template_1.compoundExpression([
            ...
            loopOverKeys_1(function (rightKey, previousKey) { return graphql_mapping_template_1.compoundExpression([
