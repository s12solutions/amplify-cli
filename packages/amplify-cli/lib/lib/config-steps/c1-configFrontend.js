...
function run(context) {
    return __awaiter(this, void 0, void 0, function () {
        var frontendPlugins, frontend, selectedFrontend, frontendModule, frontendModule;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    frontendPlugins = getFrontendPlugins(context);
                    frontend = context.exeInfo.projectConfig.frontend;
                    return [4 /*yield*/, selectFrontendHandler(context, frontendPlugins, frontend)];
                case 1:
                    selectedFrontend = _a.sent();
                    if (!(selectedFrontend !== frontend)) return [3 /*break*/, 3];
                    delete context.exeInfo.projectConfig[frontend];
                    frontendModule = require(frontendPlugins[selectedFrontend]);
                ...
                case 3:
                    frontendModule = require(frontendPlugins[selectedFrontend]);
                    return [4 /*yield*/, frontendModule.configure(context)];
                case 4:
                    _a.sent();
                    _a.label = 5;
...
function selectFrontendHandler(context, frontendPlugins, currentFrontend) {
    return __awaiter(this, void 0, void 0, function () {
        var frontend, frontendPluginList, inputParams, selectFrontend, answer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, inquirer.prompt(selectFrontend)];
                case 1:
                    answer = _a.sent();
