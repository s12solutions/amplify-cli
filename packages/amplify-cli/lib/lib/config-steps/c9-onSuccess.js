...
function run(context) {
    return __awaiter(this, void 0, void 0, function () {
        var projectPath, amplify, jsonString, projectConfigFilePath, envFilePath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    projectPath = context.exeInfo.projectPath;
                    amplify = context.amplify;
                    jsonString = JSON.stringify(context.exeInfo.projectConfig, null, 4);
                    projectConfigFilePath = amplify.pathManager.getProjectConfigFilePath(projectPath);
                    fs.writeFileSync(projectConfigFilePath, jsonString, 'utf8');
                    jsonString = JSON.stringify(context.exeInfo.localEnvInfo, null, 4);
                    envFilePath = context.amplify.pathManager.getLocalEnvFilePath();
                    fs.writeFileSync(envFilePath, jsonString, 'utf8');
                    return [4 /*yield*/, context.amplify.onCategoryOutputsChange(context)];
                case 1:
                    _a.sent();
