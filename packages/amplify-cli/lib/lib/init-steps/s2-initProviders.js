...
function run(context) {
    return __awaiter(this, void 0, void 0, function () {
        var providerPlugins, providers, initializationTasks;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    providerPlugins = getProviderPlugins(context);
                    return [4 /*yield*/, getProviders(context, providerPlugins)];
                case 1:
                    providers = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!((inputParams && inputParams.yes) || providerPluginList.length === 1)) return [3 /*break*/, 1];
