...
function editorSelection(defaultEditor) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    defaultEditor = editors.findIndex(function (editor) { return editor.value === defaultEditor; }) > -1 ?
...
function normalizeEditor(editor) {
    if (editor) {
        ...
        editor = editors.findIndex(function (editorEntry) { return editorEntry.value === editor; }) > -1 ?
            editor : undefined;
    }
    return editor;
}
