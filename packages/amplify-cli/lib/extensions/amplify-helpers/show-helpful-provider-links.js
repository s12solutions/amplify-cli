...
var getResourceStatus = require('./resource-status').getResourceStatus;
var getProviderPlugins = require('./get-provider-plugins').getProviderPlugins;
function showHelpfulProviderLinks(context) {
    return __awaiter(this, void 0, void 0, function () {
        var providers, providerPlugins, providerPromises, allResources;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    providerPromises = [];
                    return [4 /*yield*/, getResourceStatus()];
                case 1:
                    ...
                    return [2 /*return*/, Promise.all(providerPromises)];
            }
        });
    });
}
module.exports = {
    showHelpfulProviderLinks: showHelpfulProviderLinks,
};
