...
module.exports = {
    ...
    run: function (context) { return __awaiter(void 0, void 0, void 0, function () {
        var categoryPlugins, providerPlugins, combinedPlugins, answer, plugin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    categoryPlugins = context.amplify.getCategoryPlugins(context);
                    providerPlugins = context.amplify.getProviderPlugins(context);
                    combinedPlugins = __assign(__assign({}, categoryPlugins), providerPlugins);
                ...
                case 1:
                    answer = _a.sent();
                    plugin = require(combinedPlugins[answer.pluginKey]);
                    return [4 /*yield*/, plugin.console(context)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
